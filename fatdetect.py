...
site = "https://www.bestbuy.ca/en-ca/product/14962185"
...
while True:
    ...
    if buybutton.is_displayed() and buybutton.is_enabled():
        print('fats instock')
        message = clientd.messages.create(to="+17789512512", from_="+19704428794", body="Found A fat Console on " + site)
        message2 = clientd2.messages.create(to="+16049705717", from_="+12672142909", body="Found A fat Console on " + site)
        message3 = clientd3.messages.create(to="+17788665717", from_="+19318071040", body="Found A fat Console on " + site)
    else:
        print("fats out of stock")
